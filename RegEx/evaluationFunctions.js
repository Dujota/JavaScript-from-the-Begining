...
const reStr = 'Hello There'
const newStr = reStr.replace(regex, 'Hi'); // we pass in the regex we want to check and then pass in what we want to replace it with
console.log(newStr); // we get a new string that replaces Hello with Hi -- "Hi There"
